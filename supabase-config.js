...
const IOIS_SUPABASE_URL = window.IOIS_SUPABASE_URL || "https://hrvwzviprlnpkhrgzdrc.supabase.co";

const IOIS_SUPABASE_ANON_KEY = window.IOIS_SUPABASE_ANON_KEY || "sb_publishable_tXoFuC0rz0JeDOQvmpjz7w_ZAJhKOVF";


window.IOIS_SUPABASE_URL = IOIS_SUPABASE_URL;
window.IOIS_SUPABASE_ANON_KEY = IOIS_SUPABASE_ANON_KEY;
...
function ioisSupabaseConfigured() {
    ...
    if (!IOIS_SUPABASE_URL ||
        IOIS_SUPABASE_URL.includes("YOUR_SUPABASE")) {

        return false;
    }

    if (!IOIS_SUPABASE_ANON_KEY ||
        IOIS_SUPABASE_ANON_KEY.includes("YOUR_SUPABASE")) {
